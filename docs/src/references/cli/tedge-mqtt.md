...
```text command="tedge mqtt --help" title="tedge mqtt"
tedge-mqtt 
...
```text command="tedge mqtt pub --help" title="tedge mqtt pub"
tedge-mqtt-pub 
...
```text command="tedge mqtt sub --help" title="tedge mqtt sub"
tedge-mqtt-sub 
