...
If no metrics are collected, please check the [MQTT configuration](#collectdconf)
...
If not see how to [connect a device to Cumulocity IoT](./connect-c8y.md)
...
If not see how to [connect a device to Azure IoT](./connect-azure.md)
