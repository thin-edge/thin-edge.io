...
/// Transforms a request, either responding with a redirect to an HTTPS url (if the request is unsecured),
/// or letting it through unchanged
///
/// This **must** be used in combination with [Acceptor], otherwise it will unconditionally return an
/// error. This is handled when calling [start_tls_server](crate::start_tls_server)
...
#[derive(Debug)]
/// A response generated by [redirect_http_to_https], either an error, or a temporary redirect
