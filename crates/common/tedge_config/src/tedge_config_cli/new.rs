...
define_tedge_config! {
    ...
    c8y: {
        ...
        #[tedge_config(default(value = "tedge/measurements,tedge/measurements/+,tedge/alarms/+/+,tedge/alarms/+/+/+,tedge/events/+,tedge/events/+/+,tedge/health/+,tedge/health/+/+,te/device/+/+/+/m/+,te/device/+/+/+/e/+,te/device/+/+/+/a/+"))]
        topics: TemplatesSet,
