...
define_tedge_config! {
    ...
    c8y: {
        ...
        device: {
            ...
            /// Path where the device's certificate request is stored
            #[tedge_config(example = "/etc/tedge/device-certs/tedge-certificate.csr", default(from_key = "device.csr_path"))]
            #[doku(as = "PathBuf")]
            csr_path: Utf8PathBuf,
        },
