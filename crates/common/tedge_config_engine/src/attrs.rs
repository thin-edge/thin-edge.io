...
//!
//! Placed on DTO fields by `define_config!` and read at runtime via
//! facet's reflection API for read-only markers, deprecated key aliases,
//! and example values.
...
facet::define_attr_grammar! {
    ns "tedge";
    crate_path ::tedge_config_engine;
