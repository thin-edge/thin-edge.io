...
mod tests {
    ...
    async fn mapper_converts_config_download_op_for_child_device() {
        ...
        mqtt.skip(2).await; // Skip child device registration messages and 114
    ...
    async fn handle_config_update_executing_and_failed_cmd_for_main_device() {
        ...
        mqtt.send(MqttMessage::new(
            ...
            json!({
            "status": "executing",
            "tedgeUrl": "http://localhost:8888/te/v1/files/test-device/config_update/typeA-c8y-mapper-1234",
            "remoteUrl": "http://www.my.url",
    ...
    async fn handle_config_update_executing_and_failed_cmd_for_child_device() {
        ...
        mqtt.send(MqttMessage::new(
            ...
            json!({
            "status": "executing",
            "tedgeUrl": "http://localhost:8888/te/v1/files/child1/config_update/typeA-c8y-mapper-1234",
            "remoteUrl": "http://www.my.url",
            "serverUrl": "http://www.my.url",
            "type": "typeA",
        })
    ...
    async fn handle_config_update_successful_cmd_for_main_device() {
        ...
        mqtt.send(MqttMessage::new(
            ...
            json!({
            "status": "successful",
            "tedgeUrl": "http://localhost:8888/te/v1/files/test-device/config_update/path:type:A-c8y-mapper-1234",
            "remoteUrl": "http://www.my.url",
            "serverUrl": "http://www.my.url",
            "type": "path/type/A",
        })
