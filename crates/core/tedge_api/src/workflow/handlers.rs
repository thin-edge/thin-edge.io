...
///
/// Anything a script prints between this marker and [END_TEDGE_MARKER] updates the state of the
/// command, so a program which forwards the output of another one has to strip these markers.
