...
CRUD apis
    ...
    ...    curl -o /dev/null -s -w "%\{http_code\}" -X DELETE http://localhost:8000/tedge/entity-store/v1/entities/device/child01//
    Should Be Equal    ${status}    200

    ${get}=    Execute Command
    ...    curl -o /dev/null -s -w "%\{http_code\}" http://localhost:8000/tedge/entity-store/v1/entities/device/child01//
