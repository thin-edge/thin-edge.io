...
// - interval: the frequency at which the sliding window is moved
// - tick_count: size of the time windows
// - too_many: how many messages is too many (received during the last `tick_count * interval` seconds)
