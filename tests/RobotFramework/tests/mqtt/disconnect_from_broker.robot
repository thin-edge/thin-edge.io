...
tedge configure MQTT client authentication
    Execute Command    tedge config set mqtt.client.auth.cert_file /setup/client.crt
    Execute Command    tedge config set mqtt.client.auth.key_file /setup/client.key
