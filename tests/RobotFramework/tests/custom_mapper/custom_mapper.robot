...
Stop Remote TLS Broker
    ...
    Execute Command
    ...    rm -f /tmp/tb-ca.crt /tmp/tb-ca.key /tmp/tb-ca.srl /tmp/tb-server.crt /tmp/tb-server.key /tmp/tb-server.csr /tmp/tb-server.ext /tmp/tb-client.crt /tmp/tb-client.key /tmp/tb.conf /tmp/tb-mosquitto.log /tmp/tb-received.txt
    ...    timeout=0
    ...    retries=0
