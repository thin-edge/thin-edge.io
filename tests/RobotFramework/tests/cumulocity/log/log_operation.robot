...
Manual log_upload operation request
    ...
    ...    payload={"status":"init","tedgeUrl":"http://127.0.0.1:8000/te/v1/files/${DEVICE_SN}/log_upload/example-1234","type":"example","dateFrom":"${start_timestamp}","dateTo":"${end_timestamp}","searchText":"first","lines":10}
...
Trigger custom log_upload operation
    ...
    ...    payload={"status":"init","tedgeUrl":"http://127.0.0.1:8000/te/v1/files/${DEVICE_SN}/log_upload/custom-1234","type":"example","searchText":"first","lines":10}
    ...    c8y_fragment=c8y_LogfileRequest
    ${log_excerpt}=    Execute Command
    ...    curl http://127.0.0.1:8000/te/v1/files/${DEVICE_SN}/log_upload/custom-1234
