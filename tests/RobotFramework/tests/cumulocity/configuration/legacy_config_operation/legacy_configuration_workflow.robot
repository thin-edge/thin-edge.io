...
Support Legacy Configuration Download Operation
    ...
    ...    fragments={"c8y_DownloadConfigFile":{"url": "${binary_url}", "c8y_ConfigurationDump": {"id": "1111"}}}
    ...
    Cumulocity.Device Should Have Fragment Values    c8y_ConfigurationDump.id\="1111"
