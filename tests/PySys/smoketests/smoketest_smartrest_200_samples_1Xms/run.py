...
"""
Roundtrip test C8y 200 samples 1Xms delay

Given a configured system with configured certificate
When we derive from EnvironmentC8y
When we run the smoketest for REST publishing with defaults a size of 200, 10ms delay
...
class SmoketestSmartRest200Samples1Xms(Environment_roundtrip_c8y):
    def setup(self):
        super().setup()
        self.samples = "200"
        self.delay = "15"
