...
When we send a log request ( for all text with, 250 lines) from cumulocity to device and wait for some time.
...
If number of lines are greater than 250 then pass the test
