...
te/device/main///m/+                  # Telemetry (outbound)
...
2. Define CLI interface (install, remove, list, version)
3. Add plugin registration in agent configuration
4. Write unit tests for plugin logic
5. Add Robot Framework tests for end-to-end validation
